...
app.get('/api/search', async (req, res) => {
  ...
  const dailyFields = [
    ...
    "cloudCover","humidity","moonPhase","precipitationProbability","precipitationType","pressureSeaLevel","sunriseTime","sunsetTime","temperature","temperatureApparent","temperatureMax","temperatureMin","uvIndex","visibility","weatherCode","windSpeed"
  ];
  const hourlyFields = [
